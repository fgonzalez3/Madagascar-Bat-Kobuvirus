...
aa_sim <- read.csv(file = paste0(homewd, "data/orf/AA_identity.csv"), 
...
nt_sim <- read.csv(file = paste0(homewd, "data/nucleotide/NT_identity.csv"), header = T, stringsAsFactors = F)
...
datcovg <- read.csv(file = paste0(homewd, "data/coverage/Coverage.csv"), header = T, stringsAsFactors = F)
position <- read.csv(file = paste0(homewd, "data/coverage/position.csv"), header = T, stringsAsFactors = F)
